...
#include "top.h"
	...
	Top::Top(sc_module_name name):sc_module(name),cpu1("CPU1",1),cpu2("CPU2",2),cpu1_tasks_state("cpu1_tasks_state",MAX_TASK_PER_CPU),cpu2_tasks_state("cpu2_tasks_state",MAX_TASK_PER_CPU),timer1("t1"),timer2("t2")
	{
		cpu1.clock(clock);
